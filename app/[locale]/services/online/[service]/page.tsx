...
export default function ServiceDetailPage() {
  ...
  for (let i = 0; i < 10; i++) {
    const feature = t(`servicesPage.categories.online.services.${service}.features.${i}`);
    ...
    <main className="min-h-screen bg-[#f3f3f3]">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center px-4 sm:px-6 md:px-12 lg:px-16 pt-20 sm:pt-0">
        <div className="absolute top-6 sm:top-8 left-4 sm:left-6 md:left-12 lg:left-16 z-10 flex items-center gap-4">
          <button 
            onClick={() => router.push(`/${locale}/services/online`)}
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            {t(`servicesPage.categories.online.services.${service}.title`)}
          </h1>
          ...
          >
            {t(`servicesPage.categories.online.services.${service}.description`)}
          </p>
        </div>
      </section>
      ...
      <section 
        className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 lg:px-16"
        style={{
