...
const projectsData: Record<string, {
  ...
  'auge': {
    ...
    images: [
      ...
      getImageUrl('auge', 'auge-08.jpg'),
      getImageUrl('auge', 'auge-09.jpg'),
      getImageUrl('auge', 'auge-10.jpg'),
      getImageUrl('auge', 'auge-11.jpg'),
      getImageUrl('auge', 'auge-12.jpg'),
      getImageUrl('auge', 'auge-13.jpg'),
      getImageUrl('auge', 'auge-14.jpg'),
      getImageUrl('auge', 'auge-15.jpg'),
      getImageUrl('auge', 'auge-16.jpg'),
      getImageUrl('auge', 'auge-17.jpg'),
      getImageUrl('auge', 'auge-18.jpg'),
      getImageUrl('auge', 'auge-19.jpg'),
      getImageUrl('auge', 'auge-20.jpg'),
      getImageUrl('auge', 'auge-21.jpg'),
      getImageUrl('auge', 'auge-22.jpg'),
      getImageUrl('auge', 'auge-23.jpg'),
      getImageUrl('auge', 'auge-24.jpg'),
      getImageUrl('auge', 'auge-25.jpg'),
  ...
  'leap': {
    ...
    images: [
      ...
      getImageUrl('L4h', 'Mesa de trabajo 62.png'),
